...
export default function ProfileCard({ setShowProfile, data }) {
    const { uid } = useAuth();
    ...
    return (
        <div ref={wrapperRef} className="absolute flex flex-col top-12 right-2 md:right-5 bg-zinc-750 rounded-lg px-3 py-2 ">
