        ...
        <>
            <div className="max-w-[1280px] w-5/6 text-white px-6 py-10 space-y-4">
                ...
                <div className="flex flex-col items-center lg:flex-row bg-zinc-800 p-6 rounded-xl border border-zinc-700 shadow-xl gap-6">
                    ...
                    <div className="flex flex-col space-y-2 text-zinc-300 text-left flex-grow">

                        <h1 className="self-end text-yellow-300">⭐{restaurantData.rating}/5 <span className="text-zinc-300">({restaurantData.reviews.length})</span></h1>
